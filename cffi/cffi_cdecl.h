...
//auth setup
bool bip150_check_authchallenge(const uint8_t*, size_t, const bip151_channel*, const uint8_t*);
bool bip150_check_authpropose(const uint8_t*, size_t, const bip151_channel*, const uint8_t*);
bool bip150_check_authreply(uint8_t*, size_t, const bip151_channel*, const uint8_t*);

uint8_t* bip150_get_authreply(const bip151_channel*, const btc_key*);
...
bool bip15x_decrypt(bip151_channel*, const uint8_t*, uint32_t, uint8_t*);
bool bip15x_encrypt(bip151_channel*, const uint8_t*, uint32_t, uint8_t*);
